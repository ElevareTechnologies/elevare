...
export default function Service() {
    return (
        <div>
          <div>
        <div><h2 className="text-black text-lg mb-2 font-bold flex items-center justify-center">Our Services</h2>
          <h1 className="text-2xl lg:text-3xl font-bold mb-4 flex items-center justify-center">
          ...
          <div className="  container grid grid-cols-1 sm:grid-cols-2 gap-4 lg:gap-8 bg-white rounded-lg shadow-lg p-6 lg:p-10">
        {/* Web Application */}
        ...
        <div className="container font-bold">
          <h1>Our Projects</h1></div>
          <div className="container font-semibold">
          <img src={project} alt="project" className="w-full sm:w-1/2 lg:w-auto h-auto"></img>
          <h2>Lorem Ipsum is simply dummy text of the printing.</h2></div>
